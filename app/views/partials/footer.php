<footer class="bg-primary w-full">
    <div class="mx-auto w-full max-w-screen-xl p-8">
        <div class="md:flex md:justify-evenly md:gap-40">
            <div
                class="grid grid-cols-1 md:gap-20 lg:gap-32 sm:grid-cols-3 justify-items-baseline sm:justify-items-center">
                <div>
                    <div class="mb-4">
                        ...
                        <li class="mb-4">
                            <a href="https://x.com/BookReadersWeb" target="_blank" class="flex items-center gap-3 hover:underline">
                                <svg class="fill-gray-400" width="20" height="20" viewBox="0 0 103 93" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M19.0391 10.3696H31.9215L83.9609 82.8511H71.0785L19.0391 10.3696ZM64.1913 38.5527L99.7673 0.610352H86.2569L58.3334 30.3957L36.9504 0.610352H0L37.4059 52.7127L0 92.6104H13.5105L43.2652 60.874L66.0496 92.6104H103L64.1913 38.5527Z" />
                                </svg>
                                <span class="">X</span>
                            </a>
                        </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-center">
            <div class="flex flex-col gap-2">
                <span class="text-sm sm:text-center text-gray-400">© 2024 <a href="home"
                        class="hover:underline">BookReaders</a>. All Rights Reserved.</span>
                <span class="text-sm  text-gray-400">Algunas imágenes utilizadas bajo licencia Creative Commons.
                    Atribución a los respectivos autores.</span>
            </div>
        </div>
    </div>
</footer>